 ...
 * Copyright (c) 2009-2011 by ddd, Inc. All Rights Reserved.
...
//@interface dddObject : NSObject
//@end

@interface dddObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[dddObject class]])
		{
			for (NSString *key in [[(dddObject*)o modules] allKeys])
			{
