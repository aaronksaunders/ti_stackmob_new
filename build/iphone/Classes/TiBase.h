...
// in simulator we redefine to format for ddd Developer console
...
{\
	NSString * exceptionName = [@"org.ddd." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ddd";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIdddNativeItemNone = -1, 
	UIdddNativeItemSpinner = -2,
	UIdddNativeItemProgressBar = -3,
	
	UIdddNativeItemSlider = -4,
	UIdddNativeItemSwitch = -5,
	UIdddNativeItemMultiButton = -6,
	UIdddNativeItemSegmented = -7,
	
	UIdddNativeItemTextView = -8,
	UIdddNativeItemTextField = -9,
	UIdddNativeItemSearchBar = -10,
	
	UIdddNativeItemPicker = -11,
	UIdddNativeItemDatePicker = -12,
	
	UIdddNativeItemInfoLight = -13,
	UIdddNativeItemInfoDark = -14,
	
	UIdddNativeItemDisclosure = -15,
	
	UIdddNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ddd instances of
